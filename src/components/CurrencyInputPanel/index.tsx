    ...
    <Box position="relative" id={id}>
      ...
      <InputPanel>
        <Container as="label" zapStyle={zapStyle} error={error}>
          <Flex style={{display:'flex', width:'100%', justifyContent:'space-between', padding:'15px'}}>
            <Text 
              color="white"
              fontSize="14px"
          ...
          <LabelLeft>
            ...
            {account && currency && !disabled && showMaxButton && label !== 'To' && (
              <Button onClick={onMax} scale="sm" variant="secondary" style={{ textTransform: 'uppercase', border:'none' }}>
                {t('Max')}
              </Button>
            )}
